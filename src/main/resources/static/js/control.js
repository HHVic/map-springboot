			...
			case 0:{
				opt = {
						...
						visualMap: {
							type: 'piecewise',
							pieces: [
								{gt: 10000, color: 'darkred'},                        // (1500, Infinity]
								{gt: 1000, lte: 10000, color: 'red', colorAlpha: 1},  // (1000, 1500]
								{gt: 500, lte: 999, color: 'red', colorAlpha: 0.8},
								{gt: 100, lte: 499, color: 'red', colorAlpha: 0.6},
								{gt: 10, lte: 99, color: 'red', colorAlpha: 0.4},
								{gt: 0, lte: 9, color: 'red', colorAlpha: 0.3},
								{lt: 0, color: 'white', colorAlpha: 1}          // (-Infinity, 100)
							],
						},
